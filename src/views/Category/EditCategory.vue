...
export default {
    ...
    methods: {
        async editCategory() {
            try {
                // ลบคุณสมบัติ "products" ออกจากอ็อบเจ็กต์ category
                delete this.category.products;

                // ส่งคำขอ POST ไปยังเซิร์ฟเวอร์เพื่ออัปเดตหมวดหมู่
                ...
                // อัปเดตข้อมูลด้วยการส่งอีเมล์ (emit)
                this.$emit("fetchData");

                // นำทางไปยังหน้า "Category"
